...
#[ORM\Table(name: '`user`')] // Using backticks for 'user' as it can be a reserved keyword
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\NotBlank]
    #[Assert\Email(message: 'Please enter a valid email address (e.g. user@example.com).')]
    ...
    #[ORM\Column(length: 10, nullable: true)] // e.g., 'male', 'female', 'other'
     ...
     */
    #[\Symfony\Component\Validator\Constraints\Length(min: 6, minMessage: 'Password must be at least 6 characters long.')]
    ...
    public function __construct()
    {
        ...
        $this->active = true;
        // Note: $this->roles is initialized at its property declaration.
    }
